        ...
        >
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '15px', lineHeight: 1.6, marginBottom: '32px' }}>
              Fotoğraflarınız yalnızca size aittir. Photon, tüm düzenleme ve renk hesaplama işlemlerini doğrudan mobil cihazınızın yerel GPU donanımı üzerinde gerçekleştirir.
            </p>
